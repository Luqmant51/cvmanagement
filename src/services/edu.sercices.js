...
const eduserr = async (req, res) => {
    ...
    const user = await db.education.create({ user_id, degree_name1, start_date1, end_date1, degree_name2, start_date2, end_date2 })
    // console.log(user);
    // res.send(user)
    return user
}
module.exports = { eduserr }